package com.paulogrillo.blog.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.paulogrillo.blog.controllers"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/paulogrillo/blog-spring-boot-rest")
				.contact(contact()).build();
	}
	
	private static Contact contact() {
		return new Contact("Paulo Grillo", "https://github.com/paulogrillo/blog-spring-boot-rest", "contato.paulogrillo@gmail.com");
	}
